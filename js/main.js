/*
***************************
* Copyright by LittleApple*
* *************************
* 邮箱：gpxiao1118@163.com   *
* *************************
* 时间：2016年3月19日     *
* *************************
* 状态：reviewed          *
...
//section5动画
function section5(){
    move('.my-resume .content-box').set('transform','rotateY(0deg)').set('opacity',1).duration('1.3s').end();
    move('.my-blog .content-box').set('transform','rotateY(0deg)').set('opacity',1).duration('1.6s').end();
    move('.my-course .content-box').set('transform','rotateY(0deg)').set('opacity',1).duration('1.9s').end();
    move('.my-mall .content-box').set('transform','rotateY(0deg)').set('opacity',1).duration('2.1s').end();
}
//section6动画
function section6() {
    ...
    $(document).ready(function(){
        ...
        //section5动画初始化
        move('.my-resume .content-box').set('transform','rotateY(270deg)').set('opacity',0).end();
        move('.my-blog .content-box').set('transform','rotateY(270deg)').set('opacity',0).end();
        move('.my-course .content-box').set('transform','rotateY(270deg)').set('opacity',0).end();
        move('.my-mall .content-box').set('transform','rotateY(270deg)').set('opacity',0).end();
    ...
    console.log("这是他的邮箱:%c gpxiao118@163.com","color:red");
    console.log("要不打个电话试试:%c 151-5053-1896","color:red");
});//readyfunction结束
